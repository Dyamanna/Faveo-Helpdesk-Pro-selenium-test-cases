...
public class Web_235_systemStatusno extends Login_faveo_admin {
	@Test
	public void status_yes() throws InterruptedException, IOException
	{
		...
		Thread.sleep(10000);
		//to click on online disable
		driver.findElement(By.xpath(".//*[@id='formID']/div/div[2]/div[2]/div[2]/div/div/div[1]/input")).click();
		Thread.sleep(5000);
		//to submit
		...
		FileUtils.copyFile(scr3, new File("C:\\Users\\Dyamanna\\Screenshots\\235(disble).png"));	
