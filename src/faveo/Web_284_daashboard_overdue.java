...
public class Web_284_daashboard_overdue extends Login_faveo_admin {
@Test
public void click_on_inbox() throws InterruptedException, IOException
{
	SoftAssert as=new SoftAssert();
	Thread.sleep(10000);	
	driver.findElement(By.xpath("(.//*[@id='load-unassigned']/span)[2]")).click();
	Thread.sleep(6000);
	...
	FileUtils.copyFile(scrFile1, new File("C:\\Users\\Dyamanna\\Screenshots\\284(dashboard).png"));	
	as.assertAll();
