...
public class Web_270_DEbuging_disable     extends Login_faveo_admin{
	@Test
...
//		to click on admi
		...
		Thread.sleep(6000);
		//enable
		driver.findElement(By.xpath("html/body/div[1]/div/section[2]/div/div[2]/form/div/div[1]/div/div/div[2]/input")).click();
		Thread.sleep(6000);//yes
		driver.findElement(By.xpath("html/body/div[1]/div/section[2]/div/div[2]/form/div/div[2]/div/div/div[2]/input")).click();
		Thread.sleep(10000);
		File scrFile = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);//screenshot
		FileUtils.copyFile(scrFile, new File("C:\\Users\\Dyamanna\\Screenshots\\270(edit).png"));	
