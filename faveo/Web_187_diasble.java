...
public class Web_187_diasble 
extends Login_faveo_admin{
...
Thread.sleep(6000);	
driver.findElement(By.xpath(".//*[@id='order']")).sendKeys("6");//colour
...
driver.findElement(By.xpath("html/body/div[1]/div/section[2]/div/div[3]/input")).click();//save
	...
	FileUtils.copyFile(scr3,new File("C:\\Users\\Dyamanna\\Screenshots\\187(diasble).png"));
	Thread.sleep(10000);
